...
Visual overview of how I structured this project.
...
│Time │  │(48h) │   │r_5s  │  │EMA/MACD│  │(NN) │  │(Edge)│
...
VERCEL KV (Minimal Storage - Optional)
        │
...
NO LOCAL FILES
        │
        └── Only model files (~200KB, versioned in Git)
```
